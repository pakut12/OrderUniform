...
public class CompanyService {
    ...
    public static String DeleteCompany(String comp_code) {
        String status = "";
        try {
            conn = ConnectDB.getConnection();
            ps = conn.prepareStatement("delete from ou_company where comp_code = ?");
    ...
    public static String EditCompany(String comp_name, String content_type,String comp_code) {
        String status = "";
        try {
            conn = ConnectDB.getConnection();
            ps = conn.prepareStatement("update ou_company set comp_name=?,content_type=? where comp_code = ?");
