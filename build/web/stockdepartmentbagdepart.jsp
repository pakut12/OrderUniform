...
<html>
    ...
    <body>
        ...
        <div id="layout-mainpage"> 
            <form action="report/Department/ReportBagDepart.jsp" method="POST" target="new">
                <div class="container">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" id="barcode_pass">
                                        ...
                                        <div class="row mb-3" >
                                            ...
                                            <div class="col-4" >
                                                <input class="form-control form-control-sm " type="text" id="cus_no" name="cus_no" required></input>
                                            </div>
                                            <div class="col-4">
                                                <button class="btn btn-sm btn-success" type="button" id="btn-select">เลือก</button>
                                                
                                            </div>
                                        </div>
                                        <div class="row mb-3" id="search">
                                            <div class="col-4 text-end">หน่วยงานที่ 1 : </div>
                                            <div class="col-4">
                                                <select class="form-select form-select-sm " id="depart" name="depart" > 
                                                    
                                                </select>
                                            </div>
                                            <div class="col-4">
                                                <button class="btn btn-sm btn-success" type="button" id="btn-getdata">ค้นหา</button>
        ...
        $(document).ready(function(){
            ...
            $("#btn-getdata").click(function(){
                ...
                $.ajax({
                    ...
                    url:"GetDataStock",
                    data:{
                        type:"Departgetdataformbarcodedepart",
                        doc_id:data[0],
                        depart_agency:depart
                    },
                    success:function(msg){
                        $(".viewdata").html(msg);
                            ...
                            drawCallback: function (settings) {
                                ...
                                .each(function (group, i) {
                                    if (last !== group) {
                                        $(rows)
                                        .eq(i)
                                        .before('<tr class="group text-start"><td colspan="9" style="background-color: #ddd;" >' + group + '</td></tr>');
                                        last = group;
                                    }
                                });
                            }
